...
export const CURRENT_TEXT = {
    // English Display
    hero_en: "text-3xl md:text-4xl font-sans font-bold uppercase tracking-widest text-[#05121C]",
    nav_en: "text-sm font-sans font-bold tracking-wide uppercase",
    badge: "text-sm font-sans font-bold tracking-widest uppercase",

    // Korean Display
    page_title_ko: "text-4xl md:text-5xl lg:text-6xl font-bold font-yisunshin leading-tight break-keep",
    section_title_ko_display: "text-7xl font-bold font-yisunshin leading-none",
    section_heading_ko: "text-2xl font-bold font-pretendard leading-tight break-keep",
...
export const NEXT_TEXT = {
    ...
    hero_en: "text-[clamp(30px,4vw,42px)] font-sans font-bold uppercase tracking-widest text-[#05121C]",

    // Current: 14px fixed. Target: 14px fixed is usually fine for nav, but let's try fluid slightly.
    nav_en: "text-[clamp(13px,0.8vw+10px,15px)] font-sans font-bold tracking-wide uppercase",

    // Current: 14px.
    badge: "text-[12px] font-sans font-bold tracking-[0.2em] uppercase",

    // Korean Display
    // Current: 36px/48px/60px. Target: Fluid 36px to 64px.
    page_title_ko: "text-[clamp(36px,5vw+16px,64px)] font-bold font-yisunshin leading-[1.15] break-keep",

    // Current: 72px. Target: Fluid 64px to 96px.
    section_title_ko_display: "text-[clamp(64px,8vw,96px)] font-bold font-yisunshin leading-none",

    // Current: 24px. Target: Fluid 22px to 28px.
    section_heading_ko: "text-[clamp(22px,2vw+14px,28px)] font-bold font-pretendard leading-tight break-keep",

    // Body
    // Current: 18px (text-lg). Target: Fluid 16px to 19px (Conservative).
    body_ko_default: "text-[clamp(16px,0.5vw+14px,19px)] leading-relaxed break-keep font-light font-korean",

    // Current: 20px (text-xl). Target: Fluid 18px to 21px.
    body_ko_long: "text-[clamp(18px,0.5vw+16px,21px)] leading-loose break-keep font-light font-korean",

    // Verse
    verse_text: "text-[clamp(17px,0.6vw+15px,20px)] leading-relaxed break-keep font-light font-korean",
